...
"""Alembic environment — SQLAlchemy 2.0 + GeoAlchemy2."""
...
def run_migrations_online() -> None:
    ...
    with connectable.connect() as connection:
        # PostGIS images may add tiger/topology to search_path. Those extension
        # tables are not application tables and must never become DROP candidates.
